/* ============================================================
   KRYON · Dados da loja e dos produtos
   Gerado a partir do catálogo do repositório (NEXORA).
   linkPagamento = link externo de pagamento (Kairos).
   ============================================================ */

const LOJA = {
  "nome": "KRYON",
  "tagline": "Curadoria premium para a sua rotina",
  "logo": "KRYON",
  "email": "ola@kryon.store",
  "instagram": "#",
  "facebook": "#",
  "tiktok": "#",
  "footerDescricao": "A KRYON seleciona produtos práticos, bonitos e funcionais para valorizar o seu dia a dia. Design, qualidade e novas experiências em cada escolha.",
  "moeda": "BRL",
  "simboloMoeda": "R$"
};
...
const PRODUTOS = [
  ...
  },
  {
    ...
    "comoFunciona": [
      {
        ...
        "texto": "Escolha um local externo adequado e fixe a luminária na parede com parafusos ou fita dupla face."
      },
      {
        "titulo": "Deixe carregar durante o dia",
        "texto": "O painel solar aproveita a luz do sol para carregar a bateria interna (mais de 6 horas sob luz solar direta)."
      },
      {
        "titulo": "Aproveite à noite",
        "texto": "Após o carregamento, a luminária utiliza a energia armazenada para iluminar o ambiente durante toda a noite."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/HGRkX1GgMKmU"
  },
  {
    "id": "luz-noturna-usb",
    ...
    "comoFunciona": [
      {
        "titulo": "Liga à porta USB",
        "texto": "Conecta o cabo USB a um carregador, computador ou power bank."
      },
      {
        "titulo": "Coloca onde quiseres",
        "texto": "Posiciona na cabeceira, na estante ou em qualquer superfície próxima."
      },
      {
        "titulo": "Aproveita a luz",
        "texto": "Acende e desliga com facilidade para criar um ambiente acolhedor."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/Ht93RukEdoxC"
  },
  {
    ...
    "comoFunciona": [
      ...
      {
        "titulo": "Escolhe o modo",
        "texto": "Usa o controle remoto para selecionar a cor e o efeito pretendido."
      },
      {
        "titulo": "Aproveita a atmosfera",
        "texto": "Projeta estrelas no teto e nas paredes para criar o ambiente perfeito."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/kwaJx8yBqy0B"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Instala o filtro",
        "texto": "Conecta o dispenser à entrada de água seguindo as instruções do manual."
      },
      {
        "titulo": "Liga o aparelho",
        "texto": "Conecta à tomada; o bivolt funciona em 110V ou 220V automaticamente."
      },
      {
        "titulo": "Dispensa água filtrada",
        "texto": "Pressiona para obter água filtrada de forma rápida e automática."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/fN89KcMEQjJG"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Instala",
        "texto": "Enrosca no bocal como uma lâmpada comum, com a tomada conectada."
      },
      {
        "titulo": "Recarrega",
        "texto": "Fica carregando enquanto há energia na rede elétrica."
      },
      {
        "titulo": "Ilumina na queda",
        "texto": "Acende automaticamente quando a energia acaba."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/TUEmiSpNMMlv"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Instala",
        "texto": "Fixa em local externo com boa incidência de sol."
      },
      {
        "titulo": "Carrega",
        "texto": "As placas solares carregam a bateria durante o dia."
      },
      {
        "titulo": "Acende",
        "texto": "O sensor de presença liga a luz automaticamente à noite."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/lPlDxDUJJkyy"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Instala",
        "texto": "Fixa a câmera no suporte de parede no local desejado."
      },
      {
        "titulo": "Conecta",
        "texto": "Vincula a câmera ao Wi-Fi e configura no aplicativo do celular."
      },
      {
        "titulo": "Monitora",
        "texto": "Acompanha o ambiente em tempo real pelo celular, de onde estiver."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/q537SCj8v0OZ"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Carrega",
        "texto": "Conecta o cabo USB para recarregar a bateria interna."
      },
      {
        "titulo": "Acende por toque",
        "texto": "Toca no corpo da luminária para ligar e ajustar a luz."
      },
      {
        "titulo": "Leva aonde quiser",
        "texto": "Usa em qualquer lugar, sem precisar de tomada por perto."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/0ELjPIanFLmk"
  },
  {
    ...
    "descricao": "A Luminária Branca Mesa 6W traz iluminação LED eficiente e um design limpo e moderno para mesas de cabeceira, escrivaninhas e mesas de apoio. Compacta e leve, ilumina bem o espaço de trabalho ou leitura com baixo consumo de energia, sendo uma peça prática e decorativa para qualquer divisão da casa.",
    "beneficios": [
    ...
    "comoFunciona": [
      {
        "titulo": "Posiciona",
        "texto": "Coloca a luminária sobre a mesa ou escrivaninha no local desejado."
      },
      {
        "titulo": "Liga",
        "texto": "Conecta à tomada e acende a luz LED."
      },
      {
        "titulo": "Ajusta",
        "texto": "Posiciona o braço ou o difusor para iluminar exatamente o que precisa."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/458JMDEXF1Go"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Conecta o cabo USB",
        "texto": "Liga o cabo USB a um carregador, computador ou power bank."
      },
      {
        "titulo": "Liga a luminária",
        "texto": "Acende a luz ultravioleta que atrai mosquitos e insetos voadores."
      },
      {
        "titulo": "Mantém o ambiente livre",
        "texto": "Os insetos ficam presos na estrutura interna e são eliminados, enquanto a luz também ilumina o espaço."
      }
    ],
    "porqueEscolher": [
  ...
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Coloca o alimento",
        "texto": "Retira o alimento congelado e coloca-o sobre a bandeja de descongelamento."
      },
      {
        "titulo": "Espera",
        "texto": "A bandeja acelera o descongelamento sem alterar a qualidade do alimento."
      },
      {
        "titulo": "Prepara a refeição",
        "texto": "Em pouco tempo o alimento está pronto para ser temperado e cozinhado."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/q2deCZYKikNA"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Escolhe a faca certa",
        "texto": "Cada peça do conjunto tem uma função: chef, carne, cutelo, descascar ou tesoura."
      },
      {
        "titulo": "Corta com precisão",
        "texto": "As lâminas em aço inoxidável antiaderente garantem cortes precisos e duradouros."
      },
      {
        "titulo": "Guarda no estojo",
        "texto": "Depois de usar e lavar à mão, guarda todas as peças no estojo organizador."
      }
    ],
    "porqueEscolher": [
    ...
    "linkPagamento": "https://pay.kaiross.com.br/Y7VabRy5REws"
  },
  {
    ...
    "comoFunciona": [
      {
        "titulo": "Coloca a joelheira",
        "texto": "Desliza a joelheira sobre o joelho e posiciona na área que precisa de suporte."
      },
      {
        "titulo": "Ajusta o velcro",
        "texto": "Regula o fecho de velcro até obter a compressão ideal, sem restringir os movimentos."
      },
      {
        "titulo": "Treina protegido",
        "texto": "Durante a atividade, a compressão aquece e dá firmeza ao joelho, aliviando dores e prevenindo lesões."
      }
    ],
    "porqueEscolher": [
...
function produtosRelacionados(produto, limite) {
  const mesmos = PRODUTOS.filter(function (p) { return p.categoria === produto.categoria && p.id !== produto.id; });
  const restantes = PRODUTOS.filter(function (p) { return p.categoria !== produto.categoria && p.id !== produto.id; });
  return mesmos.concat(restantes).slice(0, limite || 4);
}
